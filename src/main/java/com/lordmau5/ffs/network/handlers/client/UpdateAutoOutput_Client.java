 ...
 */
public class UpdateAutoOutput_Client extends SimpleChannelInboundHandler<exTanksPacket.Client.UpdateAutoOutput> {

    @Override
    protected void channelRead0(ChannelHandlerContext ctx, exTanksPacket.Client.UpdateAutoOutput msg) throws Exception{
