...
public class WailaPluginTank implements IWailaDataProvider {
    ...
    public ItemStack getWailaStack(IWailaDataAccessor iWailaDataAccessor, IWailaConfigHandler iWailaConfigHandler) {
        ...
        if (te instanceof TileEntityTankFrame) {
            ...
            try {
                return state.getBlock().getPickBlock(iWailaDataAccessor.getBlockState(), iWailaDataAccessor.getMOP(), frame.getFakeWorld(), iWailaDataAccessor.getPosition(), iWailaDataAccessor.getPlayer());
            } catch (Exception e) {
    ...
    public List<String> getWailaBody(ItemStack itemStack, List<String> list, IWailaDataAccessor iWailaDataAccessor, IWailaConfigHandler iWailaConfigHandler) {
        ...
        if(te instanceof TileEntityFluidValve) {
            ...
            list.add("Auto Output: " + (t_Valve.getAutoOutput() ? TextFormatting.GREEN : TextFormatting.RED) + TextFormatting.ITALIC + autoOutput + TextFormatting.RESET);
        }
        if(te instanceof TileEntityMetaphaser) {
            ...
            list.add("Extract Mode: " + (t_Metaphaser.getExtract() ? TextFormatting.GREEN : TextFormatting.RED) + TextFormatting.ITALIC + autoOutput + TextFormatting.RESET);
        }
